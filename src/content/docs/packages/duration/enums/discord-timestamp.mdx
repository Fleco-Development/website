...
<Table 
    ...
    rows={
        [
            ["ShortTime", "[String](blank_https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String)", "t" , "12:00AM"],
            ["LongTime", "[String](blank_https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String)", "T" , "12:00:00AM"],
            ["ShortDate", "[String](blank_https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String)", "d" , "01/01/1970"],
            ["LongDate", "[String](blank_https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String)", "D" , "January 01, 1970"],
